...
[![version](https://img.shields.io/badge/v3.6.54-请求边界-E8D5B5?style=flat-square&labelColor=3a3026&color=E8D5B5)](https://github.com/sdyckjq-lab/llm-wiki-skill/releases)
...
| 🧷 | **工作台请求边界** | 前台只会发送已登记的请求方式与入口组合；旧接口、文件下载和事件流保持独立处理 |
...
- **工作台请求边界** — 前台只会发送已登记的请求方式与入口组合，旧接口、文件下载和事件流继续使用各自独立的处理通道
