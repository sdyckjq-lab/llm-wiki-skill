...
[![version](https://img.shields.io/badge/v3.6.54-Request%20boundaries-E8D5B5?style=flat-square&labelColor=3a3026&color=E8D5B5)](https://github.com/sdyckjq-lab/llm-wiki-skill/releases)
...
| 🧷 | **Workbench Request Boundaries** | The frontend only sends registered method-and-endpoint combinations; legacy calls, file downloads, and event streams remain isolated |
...
- **Workbench Request Boundaries** — The frontend only sends registered method-and-endpoint combinations, while legacy calls, file downloads, and event streams remain on their own isolated paths
