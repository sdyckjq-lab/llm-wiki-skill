...
- [ADR-6 完全进化为 agent，不维护双通道](./0006-evolve-to-agent-no-dual-channel.md)
...
- [ADR-9 UI 用 shadcn/ui](./0009-shadcn-ui.md)
...
- [ADR-16 长期与 llm-wiki 仓库合并（agent 是 Skill 的升级版）](./0016-merge-with-llm-wiki-repo.md)
...
- [ADR-20 阶段四启动 monorepo 合并（丙方案）](./0020-monorepo-merge.md)
- [ADR-21 图谱引擎与活地图（一个引擎、两个宿主）](./0021-graph-engine-living-map.md)
- [ADR-22 图谱交互模型——点击即阅读，选区即升级](./0022-graph-interaction-click-read-selection-upgrade.md)
...
- [ADR-32 一个图谱引擎，两个宿主](./0032-one-graph-engine-two-hosts.md)
