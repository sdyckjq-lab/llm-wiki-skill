...
test_graph_html_has_neighbor_toggle_runtime() {
    ...
    assert_file_contains "$output_dir/graph-wash.js" 'function applyNeighborsCollapsed(collapsed) {'
    assert_file_contains "$output_dir/graph-wash.js" 'function toggleNeighbors() {'
    assert_file_contains "$output_dir/graph-wash.js" 'safeLocalStorage.get("wiki-neighbors-collapsed") === "1"'
    assert_file_contains "$output_dir/graph-wash.js" 'safeLocalStorage.set("wiki-neighbors-collapsed", next ? "1" : "0")'
